            ...
            <div class=" main-content-body-invoice" id="print">
                <div class="card card-invoice">
                    <div class="card-body">
                            ...
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="tx-center"><?php echo number_format($invoice->Amount_collection, 2); ?></td>
                                        <td class="tx-right"><?php echo number_format($invoice->Amount_Commission, 2); ?></td>
                                        <td class="tx-right"><?php echo number_format($total, 2); ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="tx-right" colspan="2"><?php echo number_format($total, 2); ?></td>
                                    </tr>
                                    <tr>
                        ...
                        <hr class="mg-b-40">
                        <a href="#" class="btn btn-primary float-left mt-3 mr-2" id="print_button"
                            onclick="printDiv()">
